  ...
  const features = [
    {
      ...
      desc: 'Automate stock tracking using WhatsApp voice notes. Stop manual typing and update your inventory on the go.',
    },
    {
      icon: Receipt,
      color: '#ec4899',
      ...
      desc: 'Never lose track of a debtor again. Log who owes you and automatically monitor outstanding balances.',
    },
    {
      icon: BarChart3,
      color: '#3b82f6',
      ...
      desc: 'Get daily reports on your best-selling items, revenue, and true profit margins straight to your WhatsApp.',
    },
    {
      icon: Store,
      color: '#f59e0b',
