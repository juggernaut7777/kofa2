                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex flex-col items-center gap-1 py-2 px-4 rounded-2xl transition-all duration-300 ${active ? 'scale-105' : 'hover:scale-105 active:scale-95'
                                        }`}
                                >
                                    ...
                                    <span className={`text-[10px] font-semibold transition-all ${active ? 'text-emerald-500' : isDark ? 'text-gray-500' : 'text-gray-400'
                                        }`}>
                                        {item.label}
                                    </span>
                                </button>
